...
const Logo = ({ size = "w-16 h-16" }) => (
  <div className={`${size} relative`}>
    <div className="w-full h-full bg-white rounded-xl shadow-md flex items-center justify-center p-3">
...
const validatePassword = (password, isLogin = false) => {
  ...
  // Only for signup (stricter rules)
  if (!isLogin) {
    const upper = /[A-Z]/;
    const lower = /[a-z]/;
    const number = /[0-9]/;
            ...
            <div>
              ...
              <div className="relative">
                ...
                <ul className="text-xs mt-1 text-gray-500 list-disc list-inside">
                  <li className={(loginForm.password.length >= 8) ? "text-green-600" : "text-red-600"}>Minimum 8 characters</li>
              ...
              <p className="mt-1 text-sm text-blue-500">Password must be at least 6 characters</p>
            </div>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <ul className="text-xs mt-1 text-gray-500 list-disc list-inside">
                  <li className={(signupForm.password.length >= 8) ? "text-green-600" : "text-red-600"}>Minimum 8 characters</li>
              ...
              {errors.password && <p className="mt-1 text-sm text-red-600">{errors.password}</p>}
              <p className="mt-1 text-sm text-blue-500">Password must be 6-20 characters long</p>
            </div>
